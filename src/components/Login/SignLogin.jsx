...
const SignLogin = () => {
            ...
            >
                {({ resetForm }) => (
                    <Form className='flex flex-col gap-4'>
                     ...
                     { isLogin &&  <Button type='submit' variant='contained' sx={{ backgroundColor: '#ff6867', color: 'white' }}>
                           Sign In
                        </Button>}
                      {!isLogin && <Button type='submit' variant='contained' sx={{ backgroundColor: '#ff6867', color: 'white' }}>
                           Sign Up
    ...
    <div className={`login-body  items-center justify-center h-screen overflow-hidden w-full bg-[#ff6867] flex sm:hidden`} >
            ...
            <Box className='flex flex-col justify-center items-center gap-4 absolute bottom-[10%]'>
                ...
                <Button variant='outlined' sx={{ borderRadius: '20px', paddingInline: '50px', paddingY: '8px', color: 'white', borderColor: 'white', '&:hover': { backgroundColor: 'white', color: '#ff6867', borderColor: '#ff6867', transition: 'all', transitionDuration: '0.5s' } }}  onClick={()=>{setMobileLogin(true);setIsLogin(true)}}>Sign UP</Button>
            </Box>
        </div>
        </div>
        </>
