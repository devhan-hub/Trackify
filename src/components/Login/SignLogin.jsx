              ...
              <div className=' left-0 top-0 size-32 sm:ml-10 sm:-mt-10 relative hidden sm:block m-auto'> <img src="Images/logo2.png" alt="" /> </div>
                ...
                <Paper className='div  justify-center items-center w-[800px] max-w-[96%] h-[85vh] mt-auto mb-6 relative space-x-2 overflow-hidden hidden sm:flex ' elevation={3}>
                    ...
                    <motion.div
                        ...
                        <div className='bg-[#42a5f5]  space-y-4 h-[90vh] rounded-bl-full flex flex-col items-center justify-center text-white'>
                    ...
                    <motion.div
                        ...
                        <div className='bg-[#42a5f5]  space-y-4 h-[90vh] flex flex-col items-center rounded-br-full justify-center text-white'>
